            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseSocios" aria-labelledby="headingOne"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="#">Lista de Socios</a>
                    </nav>
                </div>
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePerguntas"
                    aria-expanded="false" aria-controls="collapsePerguntas">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-book"></i></div>
                    Perguntas
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapsePerguntas" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="#">Adicionar Perguntas</a>
                        <a class="nav-link" href="listar_perguntas.php">Lista de Perguntas</a>
                    </nav>
                </div>
