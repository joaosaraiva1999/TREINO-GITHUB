...
if (!empty($_POST)) {
    ...
    if (empty($_SESSION["erros"])) {
        ...
        $sql = "INSERT INTO utilizador (user_name, nome, data_inscricao, data_nasc, pass, telefone, email) VALUES ($user_name, $nome, $data_inscricao, $data_nasc, $pass, $tel , $data_nasc)";
        $stmt = $conn->prepare($sql);
        $hashed_pass = hash("sha512", $pass);
        $stmt->bind_param('ssssss', $user_name, $nome, $email, $hashed_pass, $data_inscricao, $data_nasc);
        $stmt->execute();
                ...
                <div class="container-fluid px-4">
                    ...
                    <div>
                        <form action="#" method="post" onsubmit="return validarDados();" enctype="multipart/form-data">
                            ...
                            <input type="text" name="nome" id="nome" minlength="3" required class="form-control mb-3">

                            <label for="email" class="form-label">Email: </label>
                            <input type="email" name="email" id="email" minlength="5" required class="form-control mb-3">

                            <label for="tel" class="form-label">Telefone: </label>
                            <input type="text" name="tel" id="tel" minlength="3" required class="form-control mb-3">
