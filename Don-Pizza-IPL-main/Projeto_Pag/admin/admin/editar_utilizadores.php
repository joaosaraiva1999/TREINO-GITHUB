...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE utilizador SET user_name = ?, nome = ?, data_inscricao = ?, data_nasc = ?, idade = ?, telefone = ?, email = ? WHERE utilizador = ?";
    $stmt = $conn->prepare($sql);
                ...
                <div class="container-fluid px-4">
                    ...
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="telefone" name="data_nasc" value="<?= htmlspecialchars($utilizador["data_nasc"]) ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="telefone" class="form-label">Idade</label>
                            <input type="number" class="form-control" id="telefone" name="idade" value="<?= htmlspecialchars($utilizador["idade"]) ?>" required>
                        </div>
                        <div class="mb-3">
