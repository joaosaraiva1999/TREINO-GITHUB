                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($avaliacao["apelido"]) ?></td>
                                        <td><?= htmlspecialchars($avaliacao["email"]) ?></td>
                                        <td><?= htmlspecialchars($avaliacao["telefone"]) ?></td>
                                        <td><?= htmlspecialchars($avaliacao["descricao"]) ?></td>
                                        <td>
