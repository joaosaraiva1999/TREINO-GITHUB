...
if (!$result) {
    die("Erro ao aceder à tabelas dos utilizadores");
}
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div>
                        <!-- colocar código para listar users -->
                        <hr>
                        <a class="btn btn-success" href="inserir_utilizador.php">Adicionar Utilizador</a>
                        <hr>

                        <table id="tabelautilizadores" class="">
                            <thead>
                                <tr>
                                    <th>
                                        ID
